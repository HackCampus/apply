  ...
  view (model, dispatch, children) {
    return html`
      <div class="questions">
        ...
        <p>You can use Markdown to format your answers, eg. to add links. If you've never used Markdown before, don't worry! There's a <a target="_blank" href="https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet">cheat sheet</a> here.</p>
