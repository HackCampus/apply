      ...
      case 'fetchCompanies':
        {
          return get('/companies', ({ statusText, data }) => {
            switch (statusText) {
              case 'OK':
                return action('fetchCompaniesSuccess', data);
              case 'Unauthorized':
                return action('fetchCompaniesUnauthorized');
              default:
                return action('fetchCompaniesFailure', data);
            }
          });
        }
      case 'fetchCompanyPreferences':
        {
          return get('/me/companies', ({ statusText, data }) => {
            switch (statusText) {
              case 'OK':
                return action('fetchCompanyPreferencesSuccess', data);
              case 'Unauthorized':
                return action('fetchCompanyPreferencesUnauthorized');
              case 'Not Found':
                return action('fetchCompanyPreferencesNotFound');
              default:
                return action('fetchCompanyPreferencesFailure', data);
            }
          });
        }
      ...
      case 'submitPreferences':
        {
          ...
          return put('/me/companies', preferences, ({ statusText, data }) => {
            switch (statusText) {
              case 'OK':
                return action('submitPreferencesSuccess', data);
              default:
                return action('submitPreferencesFailure', data);
            }
          });
        }
    }
