  ...
  view(model, dispatch, children) {
    ...
    return html`
      <div class="questions">
        ...
        ${question('bestProject', 'What is the coolest thing you have built?', html`<div>
        ...
        ${question('mostExcitingTechnology', 'What technology excites you the most?', html`<div>
        ...
        ${question('implementation', 'Can you get from a vague idea to a working system?', html`<div>
        ...
        ${question('codeReview', 'Do you have an eye for high-quality code?', html`<div>
        ...
        ${question('perfectRole', 'What would your perfect role look like?', html`<div>
