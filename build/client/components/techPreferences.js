    ...
    return html`
      <div class="techpreferences">
        ...
        <table>
          ...
          ${technologies.map(tech => html`<tr class="field"><td>${tech}</td><td>${application && readOnly ? application.techPreferences[tech] : children[tech](application ? { startingValue: application.techPreferences[tech] } : {})}</td></tr>`)}
        </table>
      </div>
    `;
  }
